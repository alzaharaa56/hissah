...
public class CategoryRequestDTO {
    ...
    public void updateEntity(Category category) {
        ...
        if (this.name != null) category.setName(this.name);
        if (this.parentCategoryId != null) category.setParentCategoryId(this.parentCategoryId);
        if (this.active != null) category.setActive(this.active);
    }
}